...
_[To be written last. Summarise the key findings and recommendations using the BLUF method.]_
...
_[To be completed. Include standout quantitative statistics, the housing affordability landscape in Canada, and why this analysis is relevant to policymakers or stakeholders.]_
...
_[To be completed. Include supplementary tables, extended model outputs, variable lists, or any supporting material referenced in the main body.]_
